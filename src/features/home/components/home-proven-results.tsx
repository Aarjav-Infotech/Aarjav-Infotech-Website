...
// FadingArrow replaced by next/image using public asset
  ...
  },
  {
    ...
    logo: (
      <div className="relative h-[43px] w-[30px] origin-right scale-[0.65]">
        ...
        />
        {/* Right/Top triangle offset by X:8.67, Y:7.8 */}
        <Image
...
export function HomeProvenResults() {
  return (
    <section className="mx-auto w-full max-w-[1440px] px-4 pt-16 pb-0 md:px-[80px] md:pt-[80px]">
      <motion.div
      ...
      <div className="mb-16 flex w-full flex-col gap-16 md:mb-20 md:gap-[342px]">
        {results.map((card, index) => (
          <motion.div
            ...
            className={cn(
              "w-full max-w-[960px] rounded-[20px] p-8 text-black md:p-10",
              index === 0 && "md:mr-auto",
              index === 1 && "md:mx-auto",
              index === 2 && "md:ml-auto",
              card.bgColor,
          ...
          >
            ...
            <div className="mb-8 flex flex-col md:mb-[50px]">
              ...
              <div className="relative flex h-[28px] w-full items-center justify-between">
                {/* ID - Matches Left Column Width */}
                <span className="text-left text-lg font-semibold md:w-[312px]">
                  {card.id}
                </span>

                {/* Center Title - Absolute for perfect centering on desktop */}
                ...
                {/* Logo - Matches Right Column Width */}
              ...
              {/* Row 2: Tags (Positioned exactly below ID) */}
            ...
            {/* Content Flex Row (3 Columns on Desktop) */}
            <div className="flex flex-col gap-[20px] md:flex-row">
              {/* Left Column - Stat Area (Exact Width: 285.33px, Height: 350px) */}
              ...
              {/* Middle Column - Details (Flex-1 / ~349px) */}
              ...
              {/* Right Column - Button Area (Exact Width: 188.54px) */}
      ...
      {/* Footer Button Area */}
      <div className="flex w-full justify-start pb-[80px]">
        <button className="flex items-center justify-center gap-2 rounded-[100px] bg-black px-8 py-4 text-[14px] font-semibold text-white transition-colors duration-300 hover:bg-black/90">
