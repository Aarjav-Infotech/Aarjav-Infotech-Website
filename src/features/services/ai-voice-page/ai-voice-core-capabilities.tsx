    ...
    <section className="bg-white py-12 sm:py-12">
      <div className="mx-auto max-w-7xl">
        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
          ...
          <div className="flex flex-col justify-between rounded-[2.5rem] border border-neutral-100 p-8 shadow-xl transition-all duration-300 lg:row-span-2">
          ...
          <div className="flex flex-col justify-between rounded-[2.5rem] border border-neutral-100 p-8 shadow-xl transition-all duration-300 md:col-span-2">
        ...
        <div className="mt-6 grid grid-cols-1 gap-6 md:grid-cols-2">
          ...
          <div className="flex flex-col justify-center rounded-[2.5rem] border border-neutral-100 p-8 shadow-xl transition-all duration-300 hover:shadow-xl hover:shadow-blue-900/5">
