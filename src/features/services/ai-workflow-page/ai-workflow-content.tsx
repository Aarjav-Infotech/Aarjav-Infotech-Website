...
const aiWorkflowHeroProps = {
  ...
  title: (
    <span className="relative inline-block leading-[1.08] tracking-[-2px] md:tracking-[-3px] ">
      AI Workflow <br className="hidden md:inline" />
      Automation
      <InlineCapsule />
    </span>
  ),
  ...
  description: "Transform repetitive business processes into intelligent AI-powered workflows that eliminate bottlenecks and drive exponential efficiency.",
...
export function AIWorkflowContent() {
  return (
    <>
      <Hero {...aiWorkflowHeroProps} />
      <AiStatisticsSection />
      <AiCoreCapabilitiesSection />
      <WhyEnterprisesChooseUs />
...
export default AIWorkflowContent;
