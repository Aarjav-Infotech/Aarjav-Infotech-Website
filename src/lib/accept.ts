/**
 * Accept header parsing for text/html vs text/markdown negotiation.
 * Follows acceptmarkdown.com / RFC 9110 §12.5.1 guidance.
 */
...
/**
 * Returns the preferred representation among text/html and text/markdown,
 * or null when the client explicitly rejects every type we produce.
 */
...
export const PRODUCED_TYPES = PRODUCES;
