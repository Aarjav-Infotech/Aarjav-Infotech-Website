...
const pages: MarkdownPage[] = [
  ...
  page(
    ...
    [
      "Aarjav Infotech is an AI-native agency based in Surat, Gujarat, India. We build human-centered AI solutions that transform workflows, enhance decision-making, and accelerate innovation across banking, healthcare, insurance, government, real estate, and industrial operations.",
      "",
  ...
  page(ROUTES.docsApi, "Aarjav Infotech API Documentation", [
    ...
    ` ${CONTACT_INFO.email} rather than calling Web3Forms directly.`,
    "",
    "## MCP tools",
    "",
...
export function getLlmsTxt(): string {
  return [
    ...
    `- [Aarjav Infotech API documentation](${APP_URL}${ROUTES.docsApi}.md): Web3Forms contact intake, MCP, and OpenAPI`,
